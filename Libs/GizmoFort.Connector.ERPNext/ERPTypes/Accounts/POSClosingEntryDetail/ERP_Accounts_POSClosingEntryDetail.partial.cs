...
{
    public partial class ERP_Accounts_POSClosingEntryDetail : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Accounts_POSClosingEntryDetail() : this(new ERPObject(_DockType.Accounts_POSClosingEntryDetail)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Accounts_POSClosingEntryDetail>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Accounts_POSClosingEntryDetail? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Accounts_POSClosingEntryDetail>(json: json);
        }
