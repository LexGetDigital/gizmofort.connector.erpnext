...
{
    public partial class ERP_Accounts_PurchaseInvoiceItem : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Accounts_PurchaseInvoiceItem() : this(new ERPObject(_DockType.Accounts_PurchaseInvoiceItem)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Accounts_PurchaseInvoiceItem>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Accounts_PurchaseInvoiceItem? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Accounts_PurchaseInvoiceItem>(json: json);
        }
