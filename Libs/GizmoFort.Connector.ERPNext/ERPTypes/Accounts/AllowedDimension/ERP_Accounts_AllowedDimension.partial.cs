...
{
    public partial class ERP_Accounts_AllowedDimension : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Accounts_AllowedDimension() : this(new ERPObject(_DockType.Accounts_AllowedDimension)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Accounts_AllowedDimension>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Accounts_AllowedDimension? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Accounts_AllowedDimension>(json: json);
        }
        ...
        public string? DimensionValue
        {
            ...
            set { data.dimension_value = value; }
        }
