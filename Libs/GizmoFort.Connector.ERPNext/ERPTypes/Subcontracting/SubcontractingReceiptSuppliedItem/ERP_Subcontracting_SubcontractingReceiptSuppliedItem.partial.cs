...
{
    public partial class ERP_Subcontracting_SubcontractingReceiptSuppliedItem : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Subcontracting_SubcontractingReceiptSuppliedItem() : this(new ERPObject(_DockType.Subcontracting_SubcontractingReceiptSuppliedItem)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Subcontracting_SubcontractingReceiptSuppliedItem>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Subcontracting_SubcontractingReceiptSuppliedItem? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Subcontracting_SubcontractingReceiptSuppliedItem>(json: json);
        }
