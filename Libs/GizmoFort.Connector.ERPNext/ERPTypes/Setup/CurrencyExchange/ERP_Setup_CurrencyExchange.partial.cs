...
namespace GizmoFort.Connector.ERPNext.ERPTypes.Setup.CurrencyExchange
{
    public partial class ERP_Setup_CurrencyExchange : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Setup_CurrencyExchange() : this(new ERPObject(_DockType.Setup_CurrencyExchange)) { }
        public ERP_Setup_CurrencyExchange(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_Setup_CurrencyExchange>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Setup_CurrencyExchange>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Setup_CurrencyExchange>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Setup_CurrencyExchange? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Setup_CurrencyExchange>(json: json);
        }
