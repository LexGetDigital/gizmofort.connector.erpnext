...
{
    public partial class ERP_Setup_EmployeeExternalWorkHistory : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Setup_EmployeeExternalWorkHistory() : this(new ERPObject(_DockType.Setup_EmployeeExternalWorkHistory)) { }
        public ERP_Setup_EmployeeExternalWorkHistory(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_Setup_EmployeeExternalWorkHistory>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Setup_EmployeeExternalWorkHistory>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Setup_EmployeeExternalWorkHistory>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Setup_EmployeeExternalWorkHistory? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Setup_EmployeeExternalWorkHistory>(json: json);
        }
