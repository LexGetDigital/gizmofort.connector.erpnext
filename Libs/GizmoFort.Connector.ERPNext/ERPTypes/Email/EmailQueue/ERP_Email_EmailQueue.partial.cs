...
{
    public partial class ERP_Email_EmailQueue : 
        ERPNextObjectBase, 
        ...
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        ...
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Email_EmailQueue>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Email_EmailQueue>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Email_EmailQueue? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Email_EmailQueue>(json: json);
        }
