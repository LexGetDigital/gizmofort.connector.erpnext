...
{
    public partial class ERP_QualityManagement_QualityGoal : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_QualityManagement_QualityGoal() : this(new ERPObject(_DockType.QualityManagement_QualityGoal)) { }
        public ERP_QualityManagement_QualityGoal(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_QualityManagement_QualityGoal>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_QualityManagement_QualityGoal>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_QualityManagement_QualityGoal>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_QualityManagement_QualityGoal? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_QualityManagement_QualityGoal>(json: json);
        }
