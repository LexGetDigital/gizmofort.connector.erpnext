...
{
    public partial class ERP_Manufacturing_BOMExplosionItem : 
        ERPNextObjectBase, 
        ...
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Manufacturing_BOMExplosionItem>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Manufacturing_BOMExplosionItem? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Manufacturing_BOMExplosionItem>(json: json);
        }
