...
{
    public partial class ERP_CRM_Prospect : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_CRM_Prospect() : this(new ERPObject(_DockType.CRM_Prospect)) { }
        public ERP_CRM_Prospect(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_CRM_Prospect>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_CRM_Prospect>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_CRM_Prospect>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_CRM_Prospect? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_CRM_Prospect>(json: json);
        }
        ...
        [Column("prospect_owner")]
        public string? ProspectOwner
        {
            get { return data.prospect_owner; }
            set { data.prospect_owner = value; }
        }
