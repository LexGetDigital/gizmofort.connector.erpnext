...
{
    public partial class ERP_Ecommerce_ItemReview : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Ecommerce_ItemReview() : this(new ERPObject(_DockType.Ecommerce_ItemReview)) { }
        public ERP_Ecommerce_ItemReview(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_Ecommerce_ItemReview>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Ecommerce_ItemReview>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Ecommerce_ItemReview>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Ecommerce_ItemReview? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Ecommerce_ItemReview>(json: json);
        }
