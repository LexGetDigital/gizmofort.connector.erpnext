...
{
    public partial class ERP_Stock_DeliveryNoteItem : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Stock_DeliveryNoteItem() : this(new ERPObject(_DockType.Stock_DeliveryNoteItem)) { }
        public ERP_Stock_DeliveryNoteItem(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_Stock_DeliveryNoteItem>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Stock_DeliveryNoteItem>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Stock_DeliveryNoteItem>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Stock_DeliveryNoteItem? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Stock_DeliveryNoteItem>(json: json);
        }
        ...
        [Column("against_sales_order")]
        public string? AgainstSalesOrder
        {
        ...
        [Column("against_sales_invoice")]
        public string? AgainstSalesInvoice
        {
        ...
        [Column("pick_list_item")]
        public string? PickListItem
        {
            get { return data.pick_list_item; }
            set { data.pick_list_item = value; }
        }
