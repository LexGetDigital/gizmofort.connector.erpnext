...
{
    public partial class ERP_Desk_NotificationLog : 
        ERPNextObjectBase, 
        ...
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        ...
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Desk_NotificationLog>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Desk_NotificationLog>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Desk_NotificationLog? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Desk_NotificationLog>(json: json);
        }
