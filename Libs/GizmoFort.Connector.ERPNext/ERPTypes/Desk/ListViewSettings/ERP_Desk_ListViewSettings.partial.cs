...
{
    public partial class ERP_Desk_ListViewSettings : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Desk_ListViewSettings() : this(new ERPObject(_DockType.Desk_ListViewSettings)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Desk_ListViewSettings>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Desk_ListViewSettings? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Desk_ListViewSettings>(json: json);
        }
        ...
        [Column("disable_count")]
        public int DisableCount
        {
            get { return data.disable_count; }
            set { data.disable_count = value; }
        }

        [Column("disable_sidebar_stats")]
        public int DisableSidebarStats
        {
            get { return data.disable_sidebar_stats; }
            set { data.disable_sidebar_stats = value; }
        }

        [Column("disable_auto_refresh")]
        public int DisableAutoRefresh
        {
            get { return data.disable_auto_refresh; }
            set { data.disable_auto_refresh = value; }
        }
