...
{
    public partial class ERP_Core_ActivityLog : 
        ERPNextObjectBase, 
        ...
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Core_ActivityLog>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Core_ActivityLog? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Core_ActivityLog>(json: json);
        }
