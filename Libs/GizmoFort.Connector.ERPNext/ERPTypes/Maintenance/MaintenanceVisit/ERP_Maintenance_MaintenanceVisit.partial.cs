...
{
    public partial class ERP_Maintenance_MaintenanceVisit : 
        ERPNextObjectBase, 
        ...
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Maintenance_MaintenanceVisit>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Maintenance_MaintenanceVisit? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Maintenance_MaintenanceVisit>(json: json);
        }
