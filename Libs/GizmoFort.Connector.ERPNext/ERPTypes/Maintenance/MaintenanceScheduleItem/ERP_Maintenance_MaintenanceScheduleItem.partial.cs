...
{
    public partial class ERP_Maintenance_MaintenanceScheduleItem : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Maintenance_MaintenanceScheduleItem() : this(new ERPObject(_DockType.Maintenance_MaintenanceScheduleItem)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Maintenance_MaintenanceScheduleItem>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Maintenance_MaintenanceScheduleItem? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Maintenance_MaintenanceScheduleItem>(json: json);
        }
