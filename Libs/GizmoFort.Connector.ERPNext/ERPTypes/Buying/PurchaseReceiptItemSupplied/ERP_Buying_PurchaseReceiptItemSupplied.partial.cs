...
{
    public partial class ERP_Buying_PurchaseReceiptItemSupplied : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Buying_PurchaseReceiptItemSupplied() : this(new ERPObject(_DockType.Buying_PurchaseReceiptItemSupplied)) { }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Buying_PurchaseReceiptItemSupplied>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Buying_PurchaseReceiptItemSupplied? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Buying_PurchaseReceiptItemSupplied>(json: json);
        }
