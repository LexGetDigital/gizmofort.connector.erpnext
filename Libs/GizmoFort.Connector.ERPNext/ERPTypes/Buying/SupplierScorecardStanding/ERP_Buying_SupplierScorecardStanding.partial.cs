...
{
    public partial class ERP_Buying_SupplierScorecardStanding : 
        ERPNextObjectBase, 
        ISerializePropertiesToJson, 
        IDeserializePropertiesFromJson<ERPNextObjectBase>
    {
        public ERP_Buying_SupplierScorecardStanding() : this(new ERPObject(_DockType.Buying_SupplierScorecardStanding)) { }
        public ERP_Buying_SupplierScorecardStanding(ERPObject obj) : base(obj) { }

        public static string? GetColumnName(string propertyName)
        {
            return ERPNextObjectBase.GetColumnName<ERP_Buying_SupplierScorecardStanding>(propertyName);
        }

        public static string? GetPropertyName(string columnName)
        {
            return ERPNextObjectBase.GetPropertyName<ERP_Buying_SupplierScorecardStanding>(columnName);
        }
        ...
        public string Serialize()
        {
            ...
            {
                DictionaryKeyPolicy = new CustomJsonSerializationPolicy<ERP_Buying_SupplierScorecardStanding>()
            };
            return JsonSerializer.Serialize(value: this.data,
                                            options: options);
        }

        public static ERP_Buying_SupplierScorecardStanding? Deserialize(string json)
        {
            //
            // deserialization is straight-forward... setters will only be called if values
            // are included in the json string
            //
            return JsonSerializer.Deserialize<ERP_Buying_SupplierScorecardStanding>(json: json);
        }
